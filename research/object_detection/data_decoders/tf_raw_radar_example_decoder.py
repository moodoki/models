...
class TfRawRadarExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self,
    ...
    image = slim_example_decoder.Image(
        image_key='image/encoded', format_key='image/format', channels=1, dtype=tf.float32,
        shape=self.shape
    )
  ...
  def decode(self, tf_example_string_tensor):
    ...
    Returns:
      ...
      fields.InputDataFields.image - 3D float32 tensor of shape [None, None, 1]
        containing radar heatmap.
    ...
    tensor_dict[fields.InputDataFields.image].set_shape(
        [None, None, 1]
    )
